...
df = pd.read_excel(r"/Users/lcotton/Documents/Scouts/troop1861/summer_camp_tool/2026_hale/CourseData.xlsx", converters={'ClassNum':str})
# print(df)
classes = []
